  ...
  <!--MAGAZİN GUNDEM ANA SLİDER-->
  <section >
      <div class="col-md-12">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"  >
            <ol class="carousel-indicators">
              <?php
              $slidersor=$baglanti->prepare("select * from slider order by slider_id DESC limit 25 ");
              $slidersor->execute();
              $i=0;
            ...
            <?php
              ...
              <div class="carousel-item <?= $actives; ?> ">
                <a href="magazin-<?=seo($slidercek["slider_ad"]).'-'.$slidercek["slider_id"]?>">
