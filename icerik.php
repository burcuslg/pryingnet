...
<div class="row">
  ...
  <div class="card">
              <div class="content-widget top-story" >
                    ...
                    <?php
                  $iceriksor=$baglanti->prepare("select * from icerik order by icerik_id DESC limit 6 ");
                  $iceriksor->execute();
                  $i=0;
                  ...
                  ?>
                    <li><a href="gundem-<?=seo($icerikcek["icerik_ad"]).'-'.$icerikcek["icerik_id"]?>"><?php echo $icerikcek['icerik_ustbaslik'];?></a></li>
                    <?php $i++; } ?>
                 </ul>
